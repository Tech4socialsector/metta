...
def get_data(from_date, to_date):
	...
	# get_data() logic (including the Gross Amt/Charity fixes verified against
	# real bills) - so this page and the underlying Script Report can never
	# drift apart into showing two different numbers for the same period.
